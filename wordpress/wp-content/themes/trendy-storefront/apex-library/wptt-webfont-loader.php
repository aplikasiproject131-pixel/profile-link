...
if ( ! function_exists( 'trendy_storefront_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function trendy_storefront_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'trendy_storefront_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function trendy_storefront_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
